...
public class ClassRoomsView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        teacherHeadingLabel.setFont(new java.awt.Font("Georgia", 0, 18)); // NOI18N
        teacherHeadingLabel.setForeground(null);
        ...
        selectClassroomPanel.setBackground(new java.awt.Color(223, 240, 216));
        selectClassroomPanel.setForeground(new java.awt.Color(102, 102, 102));
        ...
        selectGroupPanel.setBackground(new java.awt.Color(223, 240, 216));
        ...
        groupsLabel.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        groupsLabel.setForeground(java.awt.Color.gray);
        ...
        groupInfoPanel.setBackground(new java.awt.Color(223, 240, 216));
        ...
        notePrefix.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        notePrefix.setForeground(new java.awt.Color(255, 0, 51));
        notePrefix.setText("Note: Maximum number of students allowed:");

        noteValue.setForeground(new java.awt.Color(102, 102, 102));
        noteValue.setText("-1");
        ...
        teacherLabel.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        teacherLabel.setForeground(java.awt.Color.gray);
